...
##             of automatically deleting them to lessen human interaction
##             especially when operating on many sub-directories.
##
...
f_main_action () {
      ...
      date | tee -a $LOG_FILE
      #
      # Below is commented out to eliminate user-interaction especially when using script on large directory trees.
      #
      ...
      #esac
      #
      # Delete file_rename.sh log files (one per directory).
      # Delete detailed log files generated by script, file_rename.sh.
      rm file_rename*.log
      #
